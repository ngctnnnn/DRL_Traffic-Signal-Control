...
if __name__ == '__main__':
    ...
    for run in range(runs):
        env = PettingZooEnv(sumo_rl.env(net_file='nets/4x4-Lucas/4x4.net.xml',
                                                        ...
                                                        out_csv_name=f"outputs/4x4grid/double_dueling_dqn_train/double_dueling_dqn_train_{run}",
                                                        use_gui=False,
        ...
        }, local_dir='outputs/4x4grid/double_dueling_dqn_train/last_policy', checkpoint_at_end=True, 
