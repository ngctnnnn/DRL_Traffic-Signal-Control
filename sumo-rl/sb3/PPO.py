...
class PPO(OnPolicyAlgorithm):
    ...
    def train(self) -> None:
        ...
        # Logs
	result = {}
        result['entropy_loss'] = np.mean(entropy_losses)
        ...
        if hasattr(self.policy, "log_std"):
            print("train/std", th.exp(self.policy.log_std).mean().item())

        print("train/n_updates", self._n_updates, exclude="tensorboard")
        print("train/clip_range", clip_range)
        if self.clip_range_vf is not None:
            print("train/clip_range_vf", clip_range_vf)
